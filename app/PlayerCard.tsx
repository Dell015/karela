...
import { Ionicons } from '@expo/vector-icons'; // Make sure to have expo/vector-icons

/**
 * STAT CARD COMPONENT
 * Small reusable cards for individual metrics like distance, pace, etc.
 */
...
export default function PlayerCard() {
  return (
    <View style={theme.container}>
      {/* Background Glows to match your branding */}
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.profileHeader}>
          <View style={styles.imageContainer}>
            <Image 
              source={{ uri: 'https://via.placeholder.com/150' }} // Replace with user's actual image
        ...
        {/* --- GHOST ENGINE SECTION (Thesis Focus) --- */}
        <View style={styles.ghostSection}>
          ...
          <BlurView intensity={20} style={styles.ghostCard}>
            ...
            <Text style={styles.ghostSubtext}>You are currently faster than your ghost on 4/5 routes.</Text>
          </BlurView>
        </View>
