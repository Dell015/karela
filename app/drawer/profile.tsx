...
export default function ProfilePage() {
  ...
  const renderCardTab = () => (
    <View style={styles.tabContent}>
          ...
          <ProfileRow
            ...
            valueComponent={
              <Text style={styles.rowValue}>
                178cm | 22 yrs | 24.1{" "}
                <Text style={styles.successText}>(Healthy)</Text>
              </Text>
            }
          />
      ...
      <View
        style={[
          styles.sciFiCardContainer,
          { borderColor: "#209F77", borderWidth: 1 },
        ]}
      >
        <Text style={[styles.cardTitle, { color: "#52CC39" }]}>
          Engine Insights
        </Text>
        <View style={styles.cardContent}>
          <ProfileRow
          ...
          <ProfileRow
            ...
            valueComponent={
              <Text style={[styles.rowValue, { color: "#888", fontSize: 13 }]}>
                Optimized to User Baseline
              </Text>
            }
          />
        </View>
