      ...
      <Animated.View entering={FadeInUp.duration(500)} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.tabContainer}>
            ...
            {["Daily", "Weekly", "Monthly"].map((type, i) => (
              <TouchableOpacity
                ...
                onPress={() => handleToggle(type, i)}
                activeOpacity={1}
              >
                <Text
                  style={[
                    styles.tabText,
                    { color: viewType === type ? "white" : "#8E8E93" },
                  ]}
                >
                  {type}
                </Text>
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        isToday && styles.todayActiveBox,
                        hasActivity && styles.activityDotBox,
                      ]}
                    >
                      <Text
                        style={[
                          styles.modernDayText,
                          isToday && styles.todayActiveText,
                          !isToday && !hasActivity && { color: "#48484A" },
                        ]}
                      >
                        {dayNum}
                      </Text>
                      {hasActivity && !isToday && (
                        <View style={styles.smallActivityIndicator} />
                      )}
                    </TouchableOpacity>
                  );
                })}
          ...
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>{viewType} Focus</Text>
          </View>
          ...
          <NewQuestCard
            ...
            onDetails={() =>
              openDetails(
                viewType === "Daily" ? "Morning 5km" : "Running Milestone",
                "Analysis Ready",
                viewType,
              )
            }
  ...
  <View style={styles.newCard}>
    <View style={styles.cardHeaderRow}>
      ...
      <View style={styles.timeTag}>
        <Ionicons name="time-outline" size={14} color="#7CF205" />
